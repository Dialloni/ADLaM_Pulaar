...
export const TRANSLATIONS: Record<LanguageCode, UIStrings> = {
  ...
  'ff-adlm': {
    ...
    loginLine1: "𞤃𞤢𞤸𞤵 𞤢𞤨𞥆𞤵𞥅𞤶𞤭",
    loginLine2: "𞤫",
    loginLine3: "𞤯𞤫𞤥𞤺𞤢𞤤 𞤥𞤢𞥄",
    beta: "𞤒𞤫𥅼𞤮 𞤘𞤢𞤲𞤣𞤮",
    ...
    chatWelcome: "𞤳𞤮 𞤸𞤮𞤲𞤯𞤵𞤲 𞤥𞤢𞤸𞤫𞤼𞤫𞤲 𞤸𞤢𞤲𞤣𞤫؟",
    ...
    fullNameLabel: "𞤋𞤲𞥆𞤣𞤫 𞤥𞤢𞥄 𞤲𞥋𞤣𞤫𞤲",
    fullNameSubtitle: "𞤋𞤲𞥆𞤣𞤫 𞤫 𞤴𞤫𞤼𞥆𞤮𞥅𞤪𞤫",
    gandoNamingQuery: "𞤑𞤮 𞤸𞤮𞤲𞥆𞤮 𞤺𞤢𞤲𞤣𞤵 𞤲𞤮𞤣𞥆𞤢𞤼𞤢𞤥𞤢𞥄؟",
    gandoNamingSubtitle: "𞤑𞤮𞤳𞤢 𞤸𞤫𞤱𞤪𞤮𞥅𞤣𞤫 𞤯𞤵𞤲𞤯𞤮𞥅 𞤱𞤮𞤲𞤢𞤼𞤢",
